...
@section('content')
    ...
    <form method="post" action="{{ route('varosok.store') }}">
        @csrf 
        ...
        <div class="row gtr-uniform">
            ...
            <div class="col-6 col-12-xsmall">
                ...
                <input type="text" name="nev" id="nev" value="{{ old('nev') }}" placeholder="Pl. Tesztváros" required />
            </div>
            ...
            <div class="col-6 col-12-small">
                <input type="checkbox" id="megyeszekhely" name="megyeszekhely">
                <label for="megyeszekhely">Megyeszékhely</label>
            </div>
            <div class="col-6 col-12-small">
                <input type="checkbox" id="megyeijogu" name="megyeijogu">
                <label for="megyeijogu">Megyei jogú város</label>
            </div>

            <div class="col-12">
                <ul class="actions">
                    <li><input type="submit" value="Város Mentése" class="primary" /></li>
